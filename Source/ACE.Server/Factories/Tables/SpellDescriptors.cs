...
{
    public static class SpellDescriptors
    {
        ...
        static SpellDescriptors()
        {
            if (Common.ConfigManager.Config.Server.WorldRuleset == Common.Ruleset.Infiltration)
            {
                descriptors = new Dictionary<SpellId, string>
                {
                    ...
                    { SpellId.MagicResistanceOther1,            "Magic Resistance" },
                    { SpellId.MagicResistanceSelf1,             "Magic Resistance" },
                    { SpellId.LightWeaponsMasteryOther1,        "Axe Mastery" },
                    { SpellId.LightWeaponsMasterySelf1,         "Axe Mastery" },
                    { SpellId.FinesseWeaponsMasteryOther1,      "Dagger Mastery" },
                    { SpellId.FinesseWeaponsMasterySelf1,       "Dagger Mastery" },
                    { SpellId.MaceMasteryOther1,                "Mace Mastery" },
                    { SpellId.MaceMasterySelf1,                 "Mace Mastery" },
                    { SpellId.SpearMasteryOther1,               "Spear Mastery" },
                    { SpellId.SpearMasterySelf1,                "Spear Mastery" },
                    { SpellId.StaffMasteryOther1,               "Staff Mastery" },
                    { SpellId.StaffMasterySelf1,                "Staff Mastery" },
                    ...
                    { SpellId.MissileWeaponsMasteryOther1,      "Bow Mastery" },
                    { SpellId.MissileWeaponsMasterySelf1,       "Bow Mastery" },
                    { SpellId.CrossbowMasteryOther1,            "Crossbow Mastery" },
                    { SpellId.CrossbowMasterySelf1,             "Crossbow Mastery" },
                    { SpellId.AcidProtectionOther1,             "Acid Protection" },
                    { SpellId.AcidProtectionSelf1,              "Acid Protection" },
        ...
        {
            var level1Spell = SpellLevelProgression.GetLevel1SpellId(spellId);

            if (level1Spell == SpellId.Undef || !descriptors.TryGetValue(level1Spell, out var descriptor))
                return null;
