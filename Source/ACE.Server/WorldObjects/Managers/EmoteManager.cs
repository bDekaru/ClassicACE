        ...
        public float ExecuteEmote(PropertiesEmote emoteSet, PropertiesEmoteAction emote, WorldObject targetObject = null)
        {
            ...
            switch ((EmoteType)emote.Type)
            {
                ...
                case EmoteType.AwardNoShareXP:
                    ...
                    if (player != null)
                        player.EarnXP(emote.Amount64 ?? emote.Amount ?? 0, XpType.Quest, player.Level, emoteSet.WeenieClassId, 1, ShareType.None);
                ...
                case EmoteType.AwardXP:
                    ...
                    if (player != null)
                    {
                        ...
                        {
                            player.EarnXP(amt, XpType.Quest, player.Level, emoteSet.WeenieClassId, 1, ShareType.All);
                        }
                        else if (amt < 0)
                        {
                            player.SpendXP(-amt);
